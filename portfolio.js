...
function bgColorFn(selector){
       const bgColorList = ['#6930c3','#80ffdb','#252525','#f58634'];
    ...
    document.querySelector("#bgColor-btn")
            .addEventListener('click', bgColorFn)
...
//----------------------------------------------------------------------------
    ...
    document.querySelector('.check-open-btn')
    ...
    document.querySelector('.check-close-btn')
            .addEventListener('click',function(e){
               checkPoint.close();
            });
...
function creatTabFn(selector){
    ...
    function activate(target){ //a요소를 받음
...
//----------------------------------------------------------------------------
 ...
 document.querySelectorAll('.project-title')   
          .forEach( v => v.addEventListener('click',function(){
...
document.querySelectorAll('.mobile_btn')
         .forEach(v => v.addEventListener('click',function(){
